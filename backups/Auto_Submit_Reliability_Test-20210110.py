...
def xl_read():
    global app, wb, ws, ws2, username, password, lab, pscode, category, subcat, perfmby, EE1, EE2, EM, ME1, ME2, MM, \
        factory, testshort
...
def post_content():
    ...
    driver.find_element_by_id("MainContentPage_txtMaterialReusePercentage").click()
    driver.find_element_by_id("MainContentPage_txtMaterialReusePercentage").clear()
...
def return_test_number():
    ...
    # hyperlink = 'http://reliability.mot.com/ReportServer/Pages/ReportViewer.aspx?%2fgALT_V3_Reports%2fALTFunction&rs
    # :Command=Render&rc:Parameters=False&Test_Seqno=' + alt_number
...
if __name__ == "__main__":
    init(autoreset=True)
    print("\033[0;33;40m当前版本号:20210114\033[0m")
