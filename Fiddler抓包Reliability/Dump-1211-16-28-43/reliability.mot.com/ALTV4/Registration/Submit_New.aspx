...
<div class="aspNetHidden">
	...
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="" />
</div>
                                                ...
                                                <td valign="top">
                                                    <div id="MainContentPage_pnlSelectFromPHS">
                                                        ...
                                                        <input type="submit" name="ctl00$MainContentPage$btnProductLookup" value="Product Lookup" id="MainContentPage_btnProductLookup" class="Buttons" style="width:140px" /> 
                                                         <input name="ctl00$MainContentPage$txtProductSelected" type="text" id="MainContentPage_txtProductSelected" disabled="disabled" class="aspNetDisabled LargeFields" style="border-width:0pt;width:600px;" />
...
var Page_Validators =  new Array(document.getElementById("MainContentPage_cvLab"));
//]]>
</script>
